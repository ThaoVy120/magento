<?php
namespace Rokanthemes\AjaxSuite\Block\AjaxCart\Success;

/**
 * Interceptor class for @see \Rokanthemes\AjaxSuite\Block\AjaxCart\Success
 */
class Interceptor extends \Rokanthemes\AjaxSuite\Block\AjaxCart\Success implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQuoteItem');
        return $pluginInfo ? $this->___callPlugins('getQuoteItem', func_get_args(), $pluginInfo) : parent::getQuoteItem();
    }
