<?php
namespace Rokanthemes\Superdeals\Block\ProductByCat;

/**
 * Interceptor class for @see \Rokanthemes\Superdeals\Block\ProductByCat
 */
class Interceptor extends \Rokanthemes\Superdeals\Block\ProductByCat implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreUrlBlock');
        return $pluginInfo ? $this->___callPlugins('getStoreUrlBlock', func_get_args(), $pluginInfo) : parent::getStoreUrlBlock();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentTime');
        return $pluginInfo ? $this->___callPlugins('getCurrentTime', func_get_args(), $pluginInfo) : parent::getCurrentTime();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBaseUrlMediaCustom');
        return $pluginInfo ? $this->___callPlugins('getBaseUrlMediaCustom', func_get_args(), $pluginInfo) : parent::getBaseUrlMediaCustom();
    }
